...
@section('content')
    <div class="card">
        <div class="card-header">
            Veriricar el Registro de una <strong>Estación</strong></div>
        <div class="card-body">
            {!!Form::model($emisora,['route'=>['veremisora.update', $emisora->id],'method'=>'PUT','role'=>'form','enctype'=>'multipart/form-data', 'class'=>'form-horizontal'])!!}
        ...
        <div class="card-footer">
            <button class="btn btn-sm btn-primary" type="submit"  >
                <i class="fa fa-save" ></i> Verificar</button> &nbsp;
            <a href="{{route('emisora.lista.verificar')}}" class="btn btn-sm btn-danger" > <i class="fa fa-arrow-left" ></i> Regresar</a>
