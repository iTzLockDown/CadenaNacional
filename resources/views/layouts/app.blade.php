                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('importar')}}">
                            <i class="nav-icon icon-doc"></i> Importar Emisoras</a>
                    </li>

                @endif
                @if(Auth::user()->rol ==1 || Auth::user()->rol ==2 )
                <li class="nav-item">
                    <a class="nav-link" href="{{route('emisora.lista')}}">
                        <i class="nav-icon icon-microphone"></i> Emisoras</a>
                </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('emisora.lista.verificar')}}">
                            <i class="nav-icon icon-microphone"></i> Emisoras por verificar</a>
                    </li>
                @endif
                <li class="nav-item">
                    <a class="nav-link" href="{{route('usuario.password', array(Auth::user()->id))}}">
...
<footer class="app-footer">
    ...
    <div class="ml-auto">
        <span></span>
        <a href="">CADENA NACIONAL DE RADIO</a>
    </div>
</footer>
